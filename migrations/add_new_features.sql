...
CREATE INDEX idx_video_notes_created ON video_notes(created_at DESC);
...
CREATE INDEX idx_flashcards_deck ON flashcards(deck_name);
...
CREATE TABLE IF NOT EXISTS study_sessions (
  ...
  daily_goal INTEGER NOT NULL, -- minutes per day
...
CREATE INDEX idx_study_sessions_target ON study_sessions(target_date);
